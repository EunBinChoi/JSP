...
<b>empty</b><hr width="250" align="left"/>
${ empty param.name }
<%
...
%>
<!-- param.name이 null일 경우 true, 아닐 경우는 false -->
<br/>
<a href="04_operator.jsp?name=JSP">param.name 있는 요청</a><br/>
<a href="04_operator.jsp">param.name 없는 요청</a>
</body>
</html>