...
<body>
    <header class="header">
        <div class="header__logo">
            ...
            <a href="./02_boardList.jsp"><i class="fas fa-camera"></i></a>
            <a href="./02_boardList.jsp">Sallys</a>
        </div>


        <ul class="header__nav">
            <!-- block 구조여서 수직적 중앙이 맞음 -->
            <li><a href="./02_boardList.jsp">Home</a></li>
            <li><a href="./02_boardList.jsp">Board</a></li>
            <li><a href="./09_pollList.jsp">Survey</a></li>
        </ul>
        ...
        <div class="header__icons__toggle">
            <a href="#" class="header__toggleBtn" onclick="javascript:toggleMenu('.header__nav')">
