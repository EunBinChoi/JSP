...
public class PollListBean {
	...
	public PollListBean(int num) {
		super();
		this.num = num;
	}
	public PollListBean(int num, String question, String sdate, String edate, String wdate, int type, int active) {
		super();
		this.num = num;
	...
	public String toString() {
		return "PollListBean [num=" + num + ", question=" + question + ", sdate=" + sdate + ", edate=" + edate
				+ ", wdate=" + wdate + ", type=" + type + ", active=" + active + "]";
	}
