...
<body>
	...
	<%! 
		...
		String requestStyle = "<div style=\"display:block\">";
		String responseStyle = "<div style=\"display:none\">";
	%>
	...
	<%
		...
		if(request.getParameter("submit") != null) {
			requestStyle = "<div style=\"display:none\">";
			responseStyle = "<div style=\"display:block\">";
		}
	%>
	...
	<h2>request</h2>
	<form method="get">		
		<label for="arr">input your array:</label>
		<input type="text" id="arr" name="arr">
		<br/>
		<label for="radius">input your radius: </label>
