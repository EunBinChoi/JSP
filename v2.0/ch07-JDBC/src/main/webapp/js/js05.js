function isSignUpValidForm(formName) {
	...
	else if (!(isValidPass(document.forms[formName]["pwd"].value))) {
		document.forms[formName]["pwd"].focus();
		return false;
	}
	else if (!(isValidRePass(document.forms[formName]["pwd"].value, document.forms[formName]["repwd"].value))) {
		document.forms[formName]["repwd"].focus();
		return false;
	}
